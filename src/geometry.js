...
export function createPosGeometry(gl, vertexData, vertexElementData, vertexDataSize, attribLocation) {
...
export function createPosTexGeometry(gl, vertexData, vertexElementData, vertexDataSize, attribLocation, vertexTextureData, vertexElementTextureData, textureDataSize, textureAttribLocation) {
    const vao = gl.createVertexArray();
    if (!vao) {
        console.error("Falied to make vertex array");
    }
